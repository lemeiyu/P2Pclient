    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                reader = new ActualMsg();
                ActualMsg temp = reader.readActualMsg(guestPeer.getSocket());
                switch (temp.getType()) {
                    case CHOKE:
                    ...
                    case PIECE:
                        ...
                        if (peerProcess.config.getMyBitField().getHaveFile()){
                            logger.completion();
                            ActualMsg stop = new ActualMsg(ActualMsg.MsgType.HAVE);
